...
class DocToPdf extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      images: [],
  ...
  render() {
    ...
    const landing = (
      <div className="landing-page mt-20">
        ...
        {/* <div style={{ padding: "40px" }}>
          ...
          anywhere.
          <br />
          Files are processed entirely on your device and does not get uploaded
          to any server.
        </div> */}
        <div className="flex justify-center">
          <img src={photoImg} className="w-16" alt="" />{" "}
          <p className=" md:text-2xl font-bold py-4 ml-2">DOC to PDF</p>
        </div>
        <div className=" text-center text-lg font-light mb-6">
          The best web app to convert DOC to PDF
        </div>
        <div className=" md:mx-40 mx-6 flex justify-center md:pt-32 pt-16 rounded-t-lg bg-yellow-400">
          ...
          >
            <img src={photoImg} className=" h-8 w-8 mr-2" /> CHOOSE DOC File
          </button>
        </div>
        <div
        ...
        <div style={{ display: "flex" }}>
          <div
            style={{
              ...
              textAlign: "center",
              background:
                this.state.pageMargin == None ? "purple" : "rgb(240,240,240)",
              color: this.state.pageMargin == None ? "white" : "black",
              padding: "5px",
            }}
            onClick={() => this.setState({ pageMargin: None })}
          >
            None
          </div>
          <div
            style={{
              ...
              textAlign: "center",
              background:
                this.state.pageMargin == Small ? "purple" : "rgb(240,240,240)",
              color: this.state.pageMargin == Small ? "white" : "black",
              padding: "5px",
            }}
            onClick={() => this.setState({ pageMargin: Small })}
          >
            Small
          </div>
          <div
            style={{
              ...
              textAlign: "center",
              background:
                this.state.pageMargin == Big ? "purple" : "rgb(240,240,240)",
              color: this.state.pageMargin == Big ? "white" : "black",
              padding: "5px",
            }}
            onClick={() => this.setState({ pageMargin: Big })}
          >
            Big
          </div>
        </div>
    ...
    const closeBtn = this.state.forceShowOption ? (
      <span
        onClick={() => {
          this.setState({ forceShowOption: false });
        }}
      >
        X
      </span>
            ...
            style={{
              ...
              background:
                this.state.pageOrientation == Landscape
                  ...
                  : "rgb(240,240,240)",
              color:
                this.state.pageOrientation == Landscape ? "white" : "black",
              padding: "5px",
            }}
        ...
        <div style={{ display: "flex" }}>
          <div
            style={{
              ...
              cursor: "pointer",
              background:
                this.state.pageSize == A4 ? "purple" : "rgb(240,240,240)",
              color: this.state.pageSize == A4 ? "white" : "black",
              padding: "5px",
            }}
            onClick={() => this.setState({ pageSize: A4 })}
          >
            A4
          </div>
          <div
            style={{
              ...
              cursor: "pointer",
              background:
                this.state.pageSize == Letter ? "purple" : "rgb(240,240,240)",
              color: this.state.pageSize == Letter ? "white" : "black",
              padding: "5px",
            }}
            onClick={() => this.setState({ pageSize: Letter })}
          >
            US Letter
          </div>
          <div
            style={{
              ...
              cursor: "pointer",
              background:
                this.state.pageSize == Fit ? "purple" : "rgb(240,240,240)",
              color: this.state.pageSize == Fit ? "white" : "black",
              padding: "5px",
            }}
            onClick={() => this.setState({ pageSize: Fit })}
          >
            Same as Image
          </div>
        </div>
        ...
        <div style={{ display: "flex" }}>
          <div
            style={{
              ...
              cursor: "pointer",
              textAlign: "center",
              background: this.state.compressImages
                ? "purple"
                : "rgb(240,240,240)",
              color: this.state.compressImages ? "white" : "black",
              padding: "5px",
            }}
            onClick={() => this.setState({ compressImages: true })}
          >
            Compress Images
          </div>
          <div
            ...
            onClick={() => this.setState({ compressImages: false })}
          >
            Don't Compress
          </div>
        </div>
    ...
    for (let i = 0; i < fileList.length; i++) {
      ...
      if (
        !(
          ...
          fileList[i].type === "image/x-png" ||
          fileList[i].type === "image/jpeg" ||
          fileList[i].type === "image/webp"
        )
      ) {
        continue;
      }
      ...
      imgArr.push({
        ...
        imgDataUrl,
        file: fileList[i],
        /* width: img.width, height: img.height */ selected: false,
      });
    }
    this.setState((state) => ({
